    ...
    return (
        <nav style="display:flex; align-items:center; justify-content:space-between; padding:14px 24px; flex-shrink:0">
          ...
          <div style="display:flex; align-items:center; gap:10px">
            ...
            <button onClick={v.toggleDark} class="hv-ink" style="display:inline-flex; align-items:center; justify-content:center; width:32px; height:32px; border-radius:99px; border:1px solid var(--c-border); background:none; color:var(--c-text-sec); cursor:pointer; padding:0">
              {v.isLight
